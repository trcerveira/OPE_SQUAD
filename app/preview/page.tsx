// PREVIEW — Landing page com posicionamento do algoritmo Instagram 2025
// Para aprovar: diz "passa a definitivo" e copiamos para app/page.tsx
// Para descartar: diz "descarta preview" e apagamos esta pasta
...
export default function PreviewLanding() {
  return (
    <main className="min-h-screen flex flex-col bg-[#0A0E1A] text-[#F0ECE4]">
      ...
      {/* Banner de preview — só aparece nesta página */}
      <div className="bg-[#BFD64B] text-[#0A0E1A] text-center text-xs font-bold py-2 tracking-widest">
        ⚠️ PREVIEW — Esta é a versão para aprovação. A landing page real não foi alterada.
      </div>
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-24 md:py-32">
        ...
        {/* ALTERAÇÃO 1: Badge menciona o algoritmo */}
        ...
        {/* ALTERAÇÃO 2: Stats — trocar "0 posts que soam a template" por dado do algoritmo */}
        <div className="mt-14 flex flex-wrap justify-center items-center gap-10 text-sm">
          ...
          <div className="w-px h-8 bg-white/10 hidden sm:block" />
          {/* NOVO: dado do algoritmo baseado na pesquisa */}
          <div className="flex flex-col items-center gap-1">
      ...
      <section className="px-6 py-20 border-t border-white/[0.08] bg-[#0d1117]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* ALTERAÇÃO 3: Comparação com bullets de algoritmo */}
      ...
      {/* ALTERAÇÃO 4: SECÇÃO NOVA — O Instagram mudou as regras */}
      ...
      <footer className="px-8 py-8 border-t border-white/[0.08] flex items-center justify-between">
        ...
        <span className="text-[#8892a4] text-xs">v0.2 · 2026 · PREVIEW</span>
      </footer>
